...
//        PaintroidApplication.drawingSurface.setBackground();
...
//            mWorkingBitmapCanvas.setBitmap(drawableToBitmap(getResources().getDrawable(R.drawable.ic_pocket_paint_logo)));
//            drawer.setBackground(result);
            loadBitmapFromUri(getImageUri(drawableToBitmap(result), Bitmap.CompressFormat.PNG,80));
            PaintroidApplication.isPlainImage = false;
            PaintroidApplication.isSaved = false;
            PaintroidApplication.savedPictureUri = null;
            PaintroidApplication.saveCopy = true;
            LayerListener.getInstance().getCurrentLayer().setImage(drawableToBitmap(result));
            LayerListener.getInstance().refreshView();
//            PaintroidApplication.drawingSurface.setBackgroundResource(R.drawable.ic_pocket_paint_logo);
//             PaintroidApplication.drawingSurface.setBitmap(drawableToBitmap(result));
        }
    }
